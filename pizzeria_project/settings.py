...
# Point explicitly to <project_root>/.env
env_file = BASE_DIR / ".env"
environ.Env.read_env(env_file)

# TEMP probe while debugging; remove later:
print("ENV PATH:", env_file, "exists?", env_file.exists())

SECRET_KEY = env("DJANGO_SECRET_KEY")          # <-- will raise if missing
